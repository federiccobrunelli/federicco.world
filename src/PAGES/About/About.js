    ...
    <div className="about">
      ...
      <div className="aboutContent">
        ...
        <p>Hey there! <span role="img" aria-label="hello wave">👋</span><br />
          ...
          <span className="brM" />
          I have a big passion for <a className="external_link" href="https://www.youtube.com/watch?v=2ALb2b6R1uA&ab_channel=BoardSports" target="_blank" rel="noopener noreferrer">kitesurfing</a>, <a className="external_link" href="https://www.youtube.com/watch?v=vSVZrZGm6Mo&ab_channel=RedBull" target="_blank" rel="noopener noreferrer">wakeboarding</a> and all those watersports not many people know about. <span role="img" aria-label="">😂</span></p>
        <span className="brXXXL" />


        <h2>#EDUCATION</h2>
        <p>For the last 9 months, I have been studying web development while maintaining 2 jobs at <a className="external_link" href="https://www.beetsandroots.de/" target="_blank" rel="noopener noreferrer">Beets&Roots</a> and <a className="external_link" href="https://www.berlkoenig.de/" target="_blank" rel="noopener noreferrer">Berlkönig</a>.
          <span className="brM" />
          ...
          <span className="brM" />
          During this time I've been building up experience with HTML5, CSS3, Javascript-ES6 and ReactJs, mostly through <a className="external_link" href="https://www.codecademy.com/learn/paths/web-development" target="_blank" rel="noopener noreferrer">Codecademy's</a> interactive lessons and projects.
          <span className="brM" />
        ...
        <p>
          I'm looking for a Junior front-end developer position, in a young and innovative company where I can express myself, grow with the team and be able to work remotely.
            ...
            <span className="brM" />
            If you think I'm a good fit for your team, you can get in touch <Link className="Link deco" to="/hire">here</Link> and have a look at my <Link className="Link deco" to="/files/Brunelli_Federico_Resume.pdf" target="_blank" rel="noopener noreferrer">résumé</Link> in the meantime.
